# STM32F2xx toolchain, inspired by teensy and particle flags.
...
set(TARGET_FLAGS "-mcpu=cortex-m3 -mthumb -mfp16-format=ieee")
set(OPTIMIZE_FLAGS "-O2 -g3 -gdwarf-2" CACHE STRING "Optimization flags")
set(CMAKE_C_FLAGS "${OPTIMIZE_FLAGS} -Wall -ffunction-sections -fdata-sections -fno-strict-aliasing -Wstack-usage=256 ${TARGET_FLAGS}" CACHE STRING "C/C++ flags")
...
set(CXX_LINKER_FLAGS "${OPTIMIZE_FLAGS} -Wl,${LINKER_FLAGS} ${TARGET_FLAGS} --specs=nosys.specs")
...
add_definitions(-DSTM32_DEVICE -DSTM32F2XX)
add_definitions(-DUSE_STDPERIPH_DRIVER -DDFU_BUILD_ENABLE)
add_definitions(-DRELEASE_BUILD -DSPARK=1 -DPARTICLE=1)
message(STATUS "ASS")
